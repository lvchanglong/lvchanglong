<%@ page import="lvchanglong.Helper" %>
...
<footer class="footer">
	<div class="container">
		...
		<ul class="clearfix inlineBlock">
			<li>
				<i class="fa fa-copyright"></i>2014.10-${ Helper.getNian() }<span style="padding:0 3px;">${ grailsApplication.config.author.name }</span>版权所有
			</li>
			<li>
